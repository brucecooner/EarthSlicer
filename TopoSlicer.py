...
# 	nth_slices_only = 2
# 	log.slicer(f"nth_slices_only : {nth_slices_only}")
...
# 			if slice_num % nth_slices_only == 0:
# 				log.slicer(f"adding slice {slice_num}")
# 				# do some shit
...
# 			else:
# 				log.slicer(f"rejected slice num: {slice_num}")
